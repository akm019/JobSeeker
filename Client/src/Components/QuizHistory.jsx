...
const QuizHistory = () => {
  ...
  const fetchQuizHistory = async (page) => {
    try {
      setLoading(true);
      setError(null);
      const response = await fetch(`https://jobseeker-1-1buy.onrender.com/api/quiz/history?page=${page}`, {
        headers: {
  ...
  const deleteQuiz = async (quizId) => {
    ...
    try {
      const response = await fetch(`https://jobseeker-1-1buy.onrender.com/api/quiz/history/${quizId}`, {
        method: 'DELETE',
        headers: {
