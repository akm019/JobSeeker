...
const JobPost = () => {
  ...
  const fetchJobs = async () => {
    ...
    try {
      const response = await axios.get("https://jobseeker-1-1buy.onrender.com/api/MyJobs", {
        headers: {
  ...
  const handleDeleteJob = async (jobId) => {
    ...
    try {
      await axios.delete(`https://jobseeker-1-1buy.onrender.com/api/JobPost/${jobId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchApplicants = async (jobId) => {
    ...
    try {
      console.log(user)
      const response = await axios.get(`https://jobseeker-1-1buy.onrender.com/api/applications/${jobId}`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://jobseeker-1-1buy.onrender.com/api/JobPost", formData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const ApplicantsList = ({ applicants,fetchApplicants }) => {
    const handleStatusChange = async (applicationId, newStatus,jobId) => {
      ...
      try {
        await axios.patch(
          `https://jobseeker-1-1buy.onrender.com/api/applications/${applicationId}/status`,
          { status: newStatus },
          {
            headers: {
              Authorization: `Bearer ${token}`,
